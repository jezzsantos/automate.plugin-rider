...
public class NewDraftDialog extends DialogWrapper {
    ...
    public NewDraftDialog(@Nullable Project project, List<ToolkitLite> installedToolkits, List<DraftLite> drafts) {
        super(project);
        this.drafts = drafts;
        ...
        toolkits.setRenderer((list, value, index, isSelected, cellHasFocus) -> {
            ...
            if (value == null) {
                label.setText(AutomateBundle.message("dialog.NewDraft.NoToolkits.Message"));
            }
            else {
