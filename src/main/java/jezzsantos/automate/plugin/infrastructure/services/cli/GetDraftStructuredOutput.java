...
public class GetDraftStructuredOutput extends StructuredOutput<DraftDetailed> {
    ...
    @TestOnly
    public GetDraftStructuredOutput(@NotNull String id, @NotNull String name, @NotNull HashMap<String, Object> configuration) {

        super(new ArrayList<>(List.of(new StructuredOutputOutput<>() {{
            this.Values = new DraftDetailed(id, name, configuration);
        }})));
    }
