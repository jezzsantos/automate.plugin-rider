...
Editing and publishing docs is done from the [automate](https://github.com/jezzsantos/automate) project. See the [CONTRIBUTING.md](https://github.com/jezzsantos/automate/blob/main/CONTRIBUTING.md) in that project for more details.
...
1. A new [JetBrains Marketplace release](https://plugins.jetbrains.com/plugin/19421-automate) has also already been published

**Final Step**: Open the [Draft Release](https://github.com/jezzsantos/automate.plugin-rider/releases), check the details, and Publish it.
...
1. Download the `Win-x64 Binary`, `Linux-64 Binary` and `OSX-64 Binary` built artifacts from the last successful build (of the #vx.x.x-preview commit) at: https://github.com/jezzsantos/automate.plugin-rider/actions
